...
# as.data.frame.AgExpDetails <- function(object, .data, ...) {}


# AgAPIClient$set(which = "public", "ag_response",  function(studyDbId =NULL,
...
#   #class(cont) <- c("character","AgAPIClient")
#   #cont
#   
# },
# overwrite = TRUE)   
...
# as.data.frame.AgAPIClient <- function(.data, ...) {
#   
