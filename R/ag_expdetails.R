...
# AgExpDetails$set(which = "public", name = "ag_expdetails",  function(...,studyDbId =NULL,
#                                                                      format=c("json","list","data.frame")){
#   
# 
#   cont <- super$ag_response(..., studyDbId, format)
#   
#   if(format=="json"){
#     out <-  cont
#   } else if(format=="list"){
...
# # 
# library(ragapi)
# expdetail_v0118 <- AgExpDetails$new(serverURL = "https://research.cip.cgiar.org/agrofims/api/dev",
#                                     version ="/0135/r", endPoint= "/experiment/get.php")
# out_test <- expdetail_v0118$ag_expdetails( studyDbId= 6, format="data.frame")
# # 
