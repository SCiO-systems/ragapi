...
#' 
#' Weather Variables Class
#' 
#' @description Class to represent  weather measurements data from AgroFIMS. It inherents from AgAPI client class 
...
#' @export
#' 
AgWeatherMea <- R6::R6Class(
  
  classname = "AgWeatherMea",
  inherit = AgAPIClient,
  # private = list(
  ...
  public = list(
    ...
    ag_get_weather_studyId = function(studyDbId, format, ...){},
    ag_get_weather_expsiteId = function(expsiteDbId, format, ...){}
  )
)
...
#' @title  Get all weather measurements based on the agronomic study database ID
#' @description retrieve weather measurements data from AGROFIMS database with AgAPI standard
...
#' @export 
#' 
AgWeatherMea$set(which = "public", name = "ag_get_weather_studyId", 
...
#' @title  Get all weather measurements based on the experiment site ID
#' @description retrieve weather measurements data from AGROFIMS database. AGROFIMS use the AgAPI standard in order to get and post data.
#' @field ... argument inherents by AgaAPIClient
...
#' @export 
#' 
AgWeatherMea$set(which = "public", name = "ag_get_weather_expsiteId", 
